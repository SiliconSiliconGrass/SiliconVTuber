...
export default class MemoryFilter extends CozeBot {
    ...
    async selectRelatedMemoryIds(messages, userInput, agentOutput, memoryBank) {
        /**
         * Create new memories
         * @param messages 聊天记录 Array<Object>
         * @param userInput 用户此次的输入内容 String
         * @param agentOutput 智能体此次的输出内容 String
         * @param memoryBank 当前的记忆库 Array<Object>
         */
    ...
    async stepMemoryParams(messages, userInput, agentOutput, memoryBank) {
        /**
         * Update memory params (strength & resilience)
         * @param messages 聊天记录 Array<Object>
         * @param userInput 用户此次的输入内容 String
         * @param agentOutput 智能体此次的输出内容 String
         * @param memoryBank 当前的记忆库 Array<Object>
         */
        let relatedMemoryIds = await this.selectRelatedMemoryIds(messages, userInput, agentOutput, memoryBank);
        axios.post(this.url + 'stepMemoryParams', relatedMemoryIds)
        .catch((e) => {
            console.warn('An error occurred when trying to step memory params:', e);
        });
    }
}
