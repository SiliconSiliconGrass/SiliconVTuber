...
if __name__ == "__main__":
    ...
    # handle_define_speaker(name="soyo0", gpt_weights_path="/Users/indexerror/Documents/MyStuff/Projects/VueProjects/ai-vtuber-vue/ai-vtuber-support/GPT-SoVITS/GPT_weights/soyo0-e20.ckpt", sovits_weights_path="/Users/indexerror/Documents/MyStuff/Projects/VueProjects/ai-vtuber-vue/ai-vtuber-support/GPT-SoVITS/SoVITS_weights/soyo0_e12_s1116.pth", ref_wav_path="/Users/indexerror/Documents/MyStuff/Projects/VueProjects/ai-vtuber-vue/ai-vtuber-support/GPT-SoVITS/参考音频/Soyo干声素材/正常参考/うちはとても裕福になった綺麗な家に引っ越して.wav", prompt_text="うちはとても裕福になった綺麗な家に引っ越して。", prompt_language="ja")
    

    # print(speaker_list)

    # print(speaker_list['anon'].prompt, speaker_list['anon'].bert, speaker_list['anon'].phones)
    # get_tts_wav('Intro-Yui2.mov', "では、無丂のりちゃん、あなたにとって、ほうかごとは、きっちゃった聞いてみよう。はい、入りましたー。はいはい",
                # "ja", "你好你好你好你好你好你好你好你好你好你好你好你好你好你好你好", "zh", top_k= 15, top_p = 0.6, temperature = 0.6, speed = 1, inp_refs = None, spk = "default")

    # print(speaker_list)
    # print(speaker_list['default'])
    # print(speaker_list['default'].prompt)
